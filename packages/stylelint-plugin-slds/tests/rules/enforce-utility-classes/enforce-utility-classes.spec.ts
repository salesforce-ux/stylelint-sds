...
describe('slds/enforce-utility-classes rule', () => {
  it.skip('should report a message for properties that should use utility classes', async () => {
  ...
  it.skip('should not report any warnings for selectors without matching properties', async () => {
    const css = `
      .foo {
  ...
  it.skip('should only report properties that have a matching utility class', async () => {
    const css = `
      .foo {
        color: red;
      }
