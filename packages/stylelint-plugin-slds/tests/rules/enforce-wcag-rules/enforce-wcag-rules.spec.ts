  ...
  const testCases = [
    {
      ...
      `,
      expectedMessage: `Consider replacing "#ff0000" with a similar color "
1. --slds-g-color-error-container-1 
2. --slds-g-color-error-container-2 
...
" styling hook to provide better color contrast`,
    },
    {
      ...
      `,
      expectedMessage: `Consider replacing "hsl(0, 100%, 50%)" with a similar color "--slds-g-color-error-1" styling hook to provide better color contrast`,
    },
    {
