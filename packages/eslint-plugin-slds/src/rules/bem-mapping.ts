...
export const bemMapping = {
    ...
    "slds-list_horizontal-large": "slds-list--horizontal-large",
    ...
    "slds-media_small": "slds-media--small",
    "slds-media_large": "slds-media--large",
    ...
    "slds-item_label": "slds-item--label",
    "slds-item_detail": "slds-item--detail",
    "slds-list_vertical": "slds-list--vertical",
    ...
    "slds-video_center": "slds-video--center",
    "slds-video_right": "slds-video--right",
    ...
    "slds-has-block-links_space": "slds-has-block-links--space",
    "slds-has-inline-block-links_space": "slds-has-inline-block-links--space",
    "slds-list_vertical-space": "slds-list--vertical-space",
    "slds-list_vertical-space-medium": "slds-list--vertical-space-medium",
    "slds-list_dotted": "slds-list--dotted",
    "slds-list_ordered": "slds-list--ordered",
    "slds-has-dividers_top": "slds-has-dividers--top",
    "slds-has-dividers_bottom": "slds-has-dividers--bottom",
    "slds-has-dividers_around": "slds-has-dividers--around",
    "slds-has-dividers_left": "slds-has-dividers--left",
    "slds-has-dividers_right": "slds-has-dividers--right",
    "slds-assistive-text_focus": "slds-assistive-text--focus",
    ...
    "slds-button_icon-border": "slds-button--icon-border",
    ...
    "slds-button_last": "slds-button--last",
    ...
    "slds-button__icon_edit": "slds-button__icon--edit",
    ...
    "slds-button__icon_lock": "slds-button__icon--lock",
    ...
    "slds-card_empty": "slds-card--empty",
    "slds-card__body_inner": "slds-card__body--inner",
    "slds-cell-buffer_left": "slds-cell-buffer--left",
    "slds-cell-buffer_right": "slds-cell-buffer--right",
    "slds-checkbox_add-button": "slds-checkbox--add-button",
    ...
    "slds-checkbox_faux_container": "slds-checkbox--faux_container",
    "slds-checkbox_off": "slds-checkbox--off",
    "slds-checkbox_on": "slds-checkbox--on",
    ...
    "slds-datepicker_time__list": "slds-datepicker--time__list",
    ...
    "slds-dropdown_actions": "slds-dropdown--actions",
    "slds-dropdown_bottom": "slds-dropdown--bottom",
    "slds-dropdown_center": "slds-dropdown--center",
    ...
    "slds-dropdown-trigger_hover": "slds-dropdown-trigger--hover",
    "slds-file_card": "slds-file--card",
    "slds-file_overlay": "slds-file--overlay",
    "slds-file-selector_files": "slds-file-selector--files",
    ...
    "slds-file__crop_1-by-1": "slds-file__crop--1-by-1",
    "slds-file__crop_16-by-9": "slds-file__crop--16-by-9",
    "slds-file__crop_4-by-3": "slds-file__crop--4-by-3",
    "slds-file__title_card": "slds-file__title--card",
    "slds-file__title_overlay": "slds-file__title--overlay",
    "slds-flip_horizontal": "slds-flip--horizontal",
    "slds-flip_vertical": "slds-flip--vertical",
    "slds-form_compound": "slds-form--compound",
    "slds-form_inline": "slds-form--inline",
    "slds-form-element_edit": "slds-form-element--edit",
    ...
    "slds-has-cards_space": "slds-has-cards--space",
    ...
    "slds-has-dividers_around-space": "slds-has-dividers--around-space",
    "slds-has-dividers_bottom-space": "slds-has-dividers--bottom-space",
    "slds-has-dividers_top-space": "slds-has-dividers--top-space",
    "slds-has-icon_left": "slds-has-icon--left",
    "slds-has-icon_left-right": "slds-has-icon--left-right",
    "slds-has-icon_right": "slds-has-icon--right",
    "slds-icon_large": "slds-icon--large",
    "slds-icon_left": "slds-icon--left",
    "slds-icon_right": "slds-icon--right",
    "slds-icon_selected": "slds-icon--selected",
    "slds-icon_small": "slds-icon--small",
    "slds-icon_x-small": "slds-icon--x-small",
    "slds-icon_xx-small": "slds-icon--xx-small",
    "slds-icon__container_circle": "slds-icon__container--circle",
    ...
    "slds-input-has-icon_left": "slds-input-has-icon--left",
    "slds-input-has-icon_left-right": "slds-input-has-icon--left-right",
    "slds-input-has-icon_right": "slds-input-has-icon--right",
    "slds-input__icon_left": "slds-input__icon--left",
    "slds-input__icon_right": "slds-input__icon--right",
    "slds-is-sorted_asc": "slds-is-sorted--asc",
    ...
    "slds-listbox_vertical": "slds-listbox--vertical",
    "slds-listbox__option_entity": "slds-listbox__option--entity",
    "slds-listbox__option_has-meta": "slds-listbox__option--has-meta",
    "slds-listbox__option_plain": "slds-listbox__option--plain",
    ...
    "slds-media_double": "slds-media--double",
    "slds-media_reverse": "slds-media--reverse",
    "slds-media_timeline": "slds-media--timeline",
    ...
    "slds-modal_form": "slds-modal--form",
    "slds-modal_large": "slds-modal--large",
    "slds-modal_prompt": "slds-modal--prompt",
    "slds-modal__footer_directional": "slds-modal__footer--directional",
    "slds-modal__header_empty": "slds-modal__header--empty",
    "slds-navigation-list_vertical": "slds-navigation-list--vertical",
    "slds-navigation-list_vertical-inverse": "slds-navigation-list--vertical-inverse",
    "slds-navigation-list_vertical__action": "slds-navigation-list--vertical__action",
    "slds-navigation-list-vertical_shade": "slds-navigation-list-vertical--shade",
    ...
    "slds-nubbin_bottom": "slds-nubbin--bottom",
    "slds-nubbin_bottom-left": "slds-nubbin--bottom-left",
    "slds-nubbin_bottom-right": "slds-nubbin--bottom-right",
    "slds-nubbin_left": "slds-nubbin--left",
    "slds-nubbin_left-bottom": "slds-nubbin--left-bottom",
    "slds-nubbin_left-top": "slds-nubbin--left-top",
    "slds-nubbin_right": "slds-nubbin--right",
    "slds-nubbin_right-bottom": "slds-nubbin--right-bottom",
    "slds-nubbin_right-top": "slds-nubbin--right-top",
    "slds-nubbin_top": "slds-nubbin--top",
    "slds-nubbin_top-left": "slds-nubbin--top-left",
    "slds-nubbin_top-right": "slds-nubbin--top-right",
    ...
    "slds-picklist_fluid": "slds-picklist--fluid",
    ...
    "slds-popover_panel": "slds-popover--panel",
    ...
    "slds-progress_shade": "slds-progress--shade",
    ...
    "slds-radio_faux": "slds-radio--faux",
    "slds-region_narrow": "slds-region--narrow",
    "slds-section-group_is-closed": "slds-section-group--is-closed",
    ...
    "slds-spinner_inverse": "slds-spinner--inverse",
    ...
    "slds-table_cell-buffer": "slds-table--cell-buffer",
    "slds-table_col-bordered": "slds-table--col-bordered",
    "slds-table_edit": "slds-table--edit",
    "slds-table_edit_container": "slds-table--edit_container",
    ...
    "slds-table_resizable-cols": "slds-table--resizable-cols",
    "slds-table_striped": "slds-table--striped",
    ...
    "slds-tabs__item_overflow": "slds-tabs__item--overflow",
    "slds-tabs__nav-scroller_inner": "slds-tabs__nav-scroller--inner",
    ...
    "slds-timeline__media_call": "slds-timeline__media--call",
    "slds-timeline__media_email": "slds-timeline__media--email",
    "slds-timeline__media_event": "slds-timeline__media--event",
    "slds-timeline__media_task": "slds-timeline__media--task",
